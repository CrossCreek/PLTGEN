...
#ifndef SPECTRAL_IQE_H
#define SPECTRAL_IQE_H "SpectralIQE"
...
/**
 * Class which represents the spectral IQE
 *
 * @author Brian Fowler
 * @date 10/03/11
 */
class SpectralIQE : public IQE
{
public:



    explicit SpectralIQE(shared_ptr<InputDataElement> ptrInputDataElement);
...
inline
std::string
SpectralIQE::GetClassName()
{
    return(SPECTRAL_IQE_H);
}
*/
