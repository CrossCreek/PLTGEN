...
#ifndef WIDEFOV_IQE_H
#define WIDEFOV_IQE_H "WideFOVIQE"
...
/**
 * Class which represents the wide fov IQE
 *
 * @author Brian Fowler
 * @date 10/03/11
 */
class WideFOVIQE : public IQE
{
public:



    explicit WideFOVIQE(shared_ptr<InputDataElement> ptrInputDataElement);
...
inline
std::string
WideFOVIQE::GetClassName()
{
    return(WIDEFOV_IQE_H);
}
*/
