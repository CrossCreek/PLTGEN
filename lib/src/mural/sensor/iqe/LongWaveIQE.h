...
#ifndef LONGWAVE_IQE_H
#define LONGWAVE_IQE_H "LongWaveIQE"
...
/**
 * Class which represents the long wave IQE
 *
 * @author Brian Fowler
 * @date 10/03/11
 */
class LongWaveIQE : public IQE
{
public:



    explicit LongWaveIQE(shared_ptr<InputDataElement> ptrInputDataElement);
...
inline
std::string
LongWaveIQE::GetClassName()
{
    return(LONGWAVE_IQE_H);
}
*/
