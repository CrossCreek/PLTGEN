...
#ifndef BUTTERFLY_PATTERN_H
#define BUTTERFLY_PATTERN_H "ButterflyPattern"
...
/**
 *  ButterflyPattern is the class that represents a butterfly access pattern utilizing both the
 ...
 * @date 09/07/2011
 */
class ButterflyPattern : public AccessPattern
{
public:

    ButterflyPattern();
    ButterflyPattern(const ButterflyPattern &copyMe);
    virtual ~ButterflyPattern();
...
inline
string
ButterflyPattern::GetClassName()
{
    return(BUTTERFLY_PATTERN_H);
}
