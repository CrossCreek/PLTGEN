...
{
// ============================================================================
PatternLossTT3DBR::PatternLossTT3DBR(Angle threeDbHalfAngle):
    m_3DbHalfAngle( threeDbHalfAngle )
{
}
...
double
PatternLossTT3DBR::GetPatternLoss_dB( Angle offBoreSightAngle ) const
{
    double patternLoss;
    double obsAngleRatio;
    obsAngleRatio = offBoreSightAngle / m_3DbHalfAngle;
    patternLoss = 3.0 * obsAngleRatio * obsAngleRatio;
